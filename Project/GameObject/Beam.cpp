...
void Beam::Initialize(Weapon* weapon)
{
...
void Beam::ApplyGlobalVariables()
{
	GlobalVariables* globalVariables = GlobalVariables::GetInstance();
	const char* groupName = "Player";
...
void Beam::DrawParticle(const ViewProjection& viewProjection) {
	//パーティクルモデルの描画
