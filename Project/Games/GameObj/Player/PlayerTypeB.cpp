#include "PlayerTypeB.h"
#include "Engine/Framework/Object/GameObjectManager.h"
#include <numbers>

void PlayerTypeB::Initialize()
{
	//ワールドトランスフォームの初期化
...
void PlayerTypeB::Draw(const Camera& camera)
{
	model_->Draw(worldTransform_, camera);
}

void PlayerTypeB::DrawUI()
{

}

void PlayerTypeB::OnCollision(Collider* collider)
{

}

const Vector3 PlayerTypeB::GetWorldPosition() const
{
	Vector3 pos{};
...
void PlayerTypeB::MoveAnimation()
{


}

void PlayerTypeB::Move(const float speed)
{

}

void PlayerTypeB::Rotate(const Vector3& v)
{
